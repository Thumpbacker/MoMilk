...
public class HotChocolateArrowRenderer extends ArrowRenderer<HotChocolateArrow, ArrowRenderState> {
    ...
    public HotChocolateArrowRenderer(EntityRendererProvider.Context context) {
        super(context);
    }
