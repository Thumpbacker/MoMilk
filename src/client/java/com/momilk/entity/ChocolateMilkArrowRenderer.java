...
public class ChocolateMilkArrowRenderer extends ArrowRenderer<ChocolateMilkArrow, ArrowRenderState> {
    ...
    public ChocolateMilkArrowRenderer(EntityRendererProvider.Context context) {
        super(context);
    }
