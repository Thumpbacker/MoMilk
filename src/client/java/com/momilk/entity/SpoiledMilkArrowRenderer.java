...
public class SpoiledMilkArrowRenderer extends ArrowRenderer<SpoiledMilkArrow, ArrowRenderState> {
    ...
    public SpoiledMilkArrowRenderer(EntityRendererProvider.Context context) {
        super(context);
    }
