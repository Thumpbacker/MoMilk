...
public class ModBlocks {
    ...
    public static final Block DEEPSLATE_SALT_ORE = register("deepslate_salt_ore", p -> new DropExperienceBlock(UniformInt.of(0, 2), p), BlockBehaviour.Properties.ofLegacyCopy(SALT_ORE).mapColor(MapColor.DEEPSLATE).strength(4.5F, 3.0F).sound(SoundType.DEEPSLATE), true);
    ...
    public static final Block SALT_LAYER = register("salt_layer", p -> new SaltLayerBlock(p, false, true), BlockBehaviour.Properties.of().sound(SoundType.SAND).instabreak().noCollision(), false);
    public static final Block FLOATING_SALT_LAYER = register("floating_salt_layer", p -> new SaltLayerBlock(p, true, true), BlockBehaviour.Properties.of().sound(SoundType.SAND).instabreak().noCollision(), false);
    public static final Block REJUVENATING_SALT_LAYER = register("rejuvenating_salt_layer", p -> new SaltLayerBlock(p, false, false), BlockBehaviour.Properties.of().sound(SoundType.SAND).instabreak().noCollision(), false);
    public static final Block CHEESE = register("cheese", CheeseBlock::new, BlockBehaviour.Properties.of().sound(SoundType.WOOL), true);
    public static final Block BRINY_TUBE_CORAL_BLOCK = register("briny_tube_coral_block", Block::new, BlockBehaviour.Properties.ofLegacyCopy(Blocks.TUBE_CORAL_BLOCK), true);
    public static final Block BRINY_BRAIN_CORAL_BLOCK = register("briny_brain_coral_block", Block::new, BlockBehaviour.Properties.ofLegacyCopy(Blocks.BRAIN_CORAL_BLOCK), true);
    public static final Block BRINY_BUBBLE_CORAL_BLOCK = register("briny_bubble_coral_block", Block::new, BlockBehaviour.Properties.ofLegacyCopy(Blocks.BUBBLE_CORAL_BLOCK), true);
    public static final Block BRINY_FIRE_CORAL_BLOCK = register("briny_fire_coral_block", Block::new, BlockBehaviour.Properties.ofLegacyCopy(Blocks.FIRE_CORAL_BLOCK), true);
    public static final Block BRINY_HORN_CORAL_BLOCK = register("briny_horn_coral_block", Block::new, BlockBehaviour.Properties.ofLegacyCopy(Blocks.HORN_CORAL_BLOCK), true);
    public static final Block BRINY_TUBE_CORAL_FAN = register("briny_tube_coral_fan", BaseCoralFanBlock::new, BlockBehaviour.Properties.ofLegacyCopy(Blocks.TUBE_CORAL_FAN), false);
    public static final Block BRINY_FIRE_CORAL_FAN = register("briny_fire_coral_fan", BaseCoralFanBlock::new, BlockBehaviour.Properties.ofLegacyCopy(Blocks.FIRE_CORAL_FAN), false);
    public static final Block BRINY_BRAIN_CORAL_FAN = register("briny_brain_coral_fan", BaseCoralFanBlock::new, BlockBehaviour.Properties.ofLegacyCopy(Blocks.BRAIN_CORAL_FAN), false);
    public static final Block BRINY_HORN_CORAL_FAN = register("briny_horn_coral_fan", BaseCoralFanBlock::new, BlockBehaviour.Properties.ofLegacyCopy(Blocks.HORN_CORAL_FAN), false);
    public static final Block BRINY_BUBBLE_CORAL_FAN = register("briny_bubble_coral_fan", BaseCoralFanBlock::new, BlockBehaviour.Properties.ofLegacyCopy(Blocks.BUBBLE_CORAL_FAN), false);
    public static final Block BRINY_TUBE_CORAL_WALL_FAN = register("briny_tube_coral_wall_fan", BaseCoralWallFanBlock::new, BlockBehaviour.Properties.ofLegacyCopy(Blocks.TUBE_CORAL_WALL_FAN).overrideLootTable(BRINY_TUBE_CORAL_FAN.getLootTable()), false);
    public static final Block BRINY_FIRE_CORAL_WALL_FAN = register("briny_fire_coral_wall_fan", BaseCoralWallFanBlock::new, BlockBehaviour.Properties.ofLegacyCopy(Blocks.FIRE_CORAL_WALL_FAN).overrideLootTable(BRINY_FIRE_CORAL_FAN.getLootTable()), false);
    public static final Block BRINY_BRAIN_CORAL_WALL_FAN = register("briny_brain_coral_wall_fan", BaseCoralWallFanBlock::new, BlockBehaviour.Properties.ofLegacyCopy(Blocks.BRAIN_CORAL_WALL_FAN).overrideLootTable(BRINY_BRAIN_CORAL_FAN.getLootTable()), false);
    public static final Block BRINY_HORN_CORAL_WALL_FAN = register("briny_horn_coral_wall_fan", BaseCoralWallFanBlock::new, BlockBehaviour.Properties.ofLegacyCopy(Blocks.HORN_CORAL_WALL_FAN).overrideLootTable(BRINY_HORN_CORAL_FAN.getLootTable()), false);
    public static final Block BRINY_BUBBLE_CORAL_WALL_FAN = register("briny_bubble_coral_wall_fan", BaseCoralWallFanBlock::new, BlockBehaviour.Properties.ofLegacyCopy(Blocks.BUBBLE_CORAL_WALL_FAN).overrideLootTable(BRINY_BUBBLE_CORAL_FAN.getLootTable()), false);
    public static final Block BRINY_TUBE_CORAL = register("briny_tube_coral", BaseCoralPlantBlock::new, BlockBehaviour.Properties.ofLegacyCopy(Blocks.TUBE_CORAL), true);
    public static final Block BRINY_BUBBLE_CORAL = register("briny_bubble_coral", BaseCoralPlantBlock::new, BlockBehaviour.Properties.ofLegacyCopy(Blocks.BUBBLE_CORAL), true);
    public static final Block BRINY_BRAIN_CORAL = register("briny_brain_coral", BaseCoralPlantBlock::new, BlockBehaviour.Properties.ofLegacyCopy(Blocks.BRAIN_CORAL), true);
    public static final Block BRINY_FIRE_CORAL = register("briny_fire_coral", BaseCoralPlantBlock::new, BlockBehaviour.Properties.ofLegacyCopy(Blocks.FIRE_CORAL), true);
    public static final Block BRINY_HORN_CORAL = register("briny_horn_coral", BaseCoralPlantBlock::new, BlockBehaviour.Properties.ofLegacyCopy(Blocks.HORN_CORAL), true);
    public static final Block BRINY_CLOSED_EYEBLOSSOM = register("briny_closed_eyeblossom", p -> new FlowerBlock(ModEffects.DROWNING, 7.0F, p), BlockBehaviour.Properties.ofLegacyCopy(Blocks.CLOSED_EYEBLOSSOM), true);
    public static final Block BRINY_OPEN_EYEBLOSSOM = register("briny_open_eyeblossom", p -> new FlowerBlock(ModEffects.DROWNING, 7.0F, p), BlockBehaviour.Properties.ofLegacyCopy(Blocks.OPEN_EYEBLOSSOM), true);
    ...
    public static final Block WRAPPED_BAMBOO_BLOCK = register("wrapped_bamboo_block", RotatedPillarBlock::new, BlockBehaviour.Properties.ofLegacyCopy(Blocks.BAMBOO_BLOCK), true);
    public static final Block STRIPPED_WRAPPED_BAMBOO_BLOCK = register("stripped_wrapped_bamboo_block", RotatedPillarBlock::new, BlockBehaviour.Properties.ofLegacyCopy(Blocks.STRIPPED_BAMBOO_BLOCK), true);
